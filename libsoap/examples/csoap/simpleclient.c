...
*/
static const char *url = "http://tclisapp:9080/lm-at/referentielclientservice/referentielclientprocess";
static const char *urn = "";
static const char *method = "rechercherClientParNumeroFidelite";
